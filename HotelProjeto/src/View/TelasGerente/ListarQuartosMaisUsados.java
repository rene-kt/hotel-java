 ...
 * @author Rebeca
 */
public class ListarQuartosMaisUsados extends javax.swing.JFrame {

    /**
     * Creates new form ListarQuartosMaisUsados
     */
    public ListarQuartosMaisUsados() {
        initComponents();
        listarQuartos();
    }
     public void listarQuartos() {
        ...
        for (Quarto h : qDAO.listar_usados()) {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Quartos mais usados");
        jPanel7.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 40, -1, -1));
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Número Quarto", "Preço", "Andar", "Nª de reservas"
            }
        ) {
        ...
        jPanel7.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 610, 470));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarQuartosMaisUsados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarQuartosMaisUsados().setVisible(true);
            }
        });
    }
